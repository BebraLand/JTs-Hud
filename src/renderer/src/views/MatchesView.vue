...
<template>
  <div class="p-6 bg-surface text-zinc-200 min-h-screen relative">
    <MatchesPageHeader :read-only="isMatReadOnly" @create="openCreate" />
        ...
        <div class="flex items-center gap-3">
          <div class="size-10 flex items-center justify-center shrink-0">
            <img
              ...
              :src="resolveAssetUrl(getTeamLogo(item.left.id), baseUrl)"
          ...
          <div class="size-10 flex items-center justify-center shrink-0">
            <img
              ...
              :src="resolveAssetUrl(getTeamLogo(item.right.id), baseUrl)"
              class="w-full h-full object-contain"
            />
          </div>
        </div>
