...
<template>
  ...
  >
    ...
    >
      <!-- Expanded view -->
       <div @click="openTwitch" title="Open Twitch channel" class="cursor-pointer hover:bg-surface-hover rounded-lg px-2 py-1 flex items-center gap-2">
